...
story2 = Story(
    ["noun", "verb", "adjective"],
    """The {adjective} {noun} decided to {verb} in the morning."""
)

story3 = Story(
    ["name", "place", "adjective", "plural_noun", "verb"],
    """{name} went to the {place} where they saw {adjective} {plural_noun}.
       They decided to {verb} with them."""
)
